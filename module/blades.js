...
Hooks.once("init", async function () {
  ...
  // CONFIG.Dice.template = "systems/band-of-blades/templates/blades-roll.html"
  // CONFIG.Dice.tooltip = "systems/band-of-blades/templates/blades-roll-tooltip.html"
  ...
  Actors.registerSheet("blades", BladesActorSheet, {
    types: ["character"],
    makeDefault: true,
  });
  Actors.registerSheet("blades", BladesCrewSheet, {
    types: ["crew"],
    makeDefault: true,
  });
